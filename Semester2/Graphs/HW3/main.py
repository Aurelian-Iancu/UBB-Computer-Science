...
class UI:
    ...
    def __shortest_path_matrix_multiplication(self):
        ...
        print("The lowest cost walk has the cost: ", self._graphs[self._current].get_shortest_cost(firstVertex, secondVertex))
    ...
    def start(self):
        ...
        command_dict = {"1": self.create_random_graph_ui, "2": self.read_graph_from_file_ui,
                        ...
                        "23": self.__shortest_path_matrix_multiplication}
        while not done:
            try:
                self.print_menu()
