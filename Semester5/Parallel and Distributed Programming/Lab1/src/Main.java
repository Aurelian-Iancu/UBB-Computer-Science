...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < NUMBER__OF_THREADS; i++) {
            ...
            for (int j = 0; j < product; j++) {
                ...
                b.add(products.get(productId), quantity);
            }
            recordOfSales.add(b);
    ...
    private static void WriteInFile() {
        int i = 0;
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Users\\Aurelian\\Documents\\GitHub\\Personal\\UBB-Computer-Science\\Semester5\\Parallel and Distributed Programming\\Lab1\\src\\data\\products.txt"));
            while ( i < 1000 ) {
                Random r = new Random();
    ...
    private static void ReadFromFile() {
        File file = new File("C:\\Users\\Aurelian\\Documents\\GitHub\\Personal\\UBB-Computer-Science\\Semester5\\Parallel and Distributed Programming\\Lab1\\src\\data\\products.txt");
        try {
