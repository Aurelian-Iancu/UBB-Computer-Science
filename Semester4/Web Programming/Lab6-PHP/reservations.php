...
<html lang="en">
        ...
        <div class="container text-center" id="viewReservationsDiv">
            ...
            <div id="buttons" class="container text-center">
                ...
                <form method="post">
                    ...
                    <br></br>
                    <div id="EDITERS" class="mb-1">
                        <form id="editForm" method="post" action="editreservation.php">
                            <label for="DELETERSinput" class="form-label">Id: </label>
                            <input type="text" id="DELETERSinput" name="id" class="form-control mb-3">
                            <button id="editReservation" type="submit" class="btn btn-primary mb-3">Edit reservation</button>
                        </form>
                    </div>
                    <br></br>
                    <div id="DELETERS" class="mb-1">
                    <form id="deleteForm" method="post"> 
                        <label for="DELETERSinput" class="form-label">Id: </label>
                        <input type="text" id="DELETERSinput" class="form-control mb-3">
                        <button id="DELETERS" type="submit" class="btn btn-primary mb-3">Delete reservation</button>
                    </form>
                    </div>
                <br></br>
                <form method="post">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#EDITERS input').val(id);
            $('#DELETERS input').val(id);
            $('#editForm').submit(function(e) {
                // Prevent the default form submission
                e.preventDefault();

                // Get the entered value
                var id = $('#DELETERSinput').val();
