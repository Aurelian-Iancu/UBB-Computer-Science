...
class DBConnection 
{
    ...
    public function getRoomByCategory($category) 
    {
        if (!empty($category))
        {
            $stmt = $this->pdo->prepare("SELECT rooms.id, rooms.room_number, rooms.category, rooms.price
            FROM rooms
    ...
    public function getAllRooms() 
    {
        ...
        // $stmt = $this->pdo->query("SELECT rooms.id rooms.room_number, rooms.category, rooms.price
        // FROM rooms
        // INNER JOIN hotels
